...
# model_path = '/home/rs/21CS91R01/research/2023_ICVGIP-Code/baseline1/models/new_texture_model_deploy.model'
...
def resnet_v1(input_shape, depth, num_classes=140, attention_module='se_block'):
...
def train_model(X_train, y_train, X_val, y_val, num_classes, epochs=100, batch_size=32):
...
# Train the model and get the history
def train():
    history, model = train_model(x_train, y_train, x_test, y_test, num_classes=140, epochs=100, batch_size=32)
    ...
    model_path = '/home/rs/21CS91R01/research/2023_ICVGIP-Code-1/models/fvc2006db3a_100epochs.h5'
...
def deploy():
    ...
    features_dict={}  
    concate_folder = '/home/rs/21CS91R01/research/2023_ICVGIP-Code-1/models/resnet_100'
