...
model_path = '/home/rs/21CS91R01/research/2023_ICVGIP-Code/baseline1/models/resnet_se_new.h5'
...
def resnet_v1(input_shape, depth, num_classes=140, attention_module='se_block',model_path=None):
...
# Train the model and get the history
    ...
    model = resnet_v1(input_shape=(224, 224, 3), depth=depth, attention_module='se_block',model_path=None, num_classes=140)
...
def deploy():
    ...
    folder = '/home/rs/21CS91R01/research/2023_ICVGIP-Code/datasets/FVC2006DB2_A'
    ...
    # compare feature_dict keys with image name
        if image_name.endswith('.bmp'):
            ...
            model = resnet_v1(input_shape=(224, 224, 3), depth=20, attention_module='se_block',model_path=model_path)
